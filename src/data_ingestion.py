...
class DataIngestion:
    def __init__(self, config):
        ...
        logger.info(f"Data Ingestion started with {self.bucket_name} bucket and {self.file_name} file")
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.error("Error occurred while downloading the CSV file")
            raise CustomException("Failed to download the CSV file ", e)
    
    def split_data(self):
        try:
            logger.info("Initiating the splitting process")
